...
VPC with multiple AZs with a public/private for each AZs
 
1 containers in private subnets behind a Application Load Balancer (ALB)

Used bastion host inorder to do the configuration.

Also created Route53 hosted zone , and created the records for it as well.
